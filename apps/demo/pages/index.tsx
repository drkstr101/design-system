...
import ReorderableListView from '../components/reorderable-list-view';
...
export function Index() {
  ...
  return (
    <div className={styles.page}>
      <Head>
        <title>APS Design System</title>
        <meta
          name="description"
          content="design-system demo for the American Physical Society"
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <Heading level={1}>APS Design System</Heading>
